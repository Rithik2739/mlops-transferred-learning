...
train_data_dir = 'C:\\Users\\rithi\\mlops-ws\\data\\train'
validation_data_dir = 'C:\\Users\\rithi\\mlops-ws\\data\\val'
...
checkpoint = ModelCheckpoint("face_reco.h5",
                             monitor="val_loss",
                             mode="min",
                             save_best_only = True,
                             verbose=1)
...
celebrity_dict_n = {"n0": "ben_afflek", 
...
for i in range(0,5):
    input_im = getRandomImage("C:\\Users\\rithi\\mlops-ws\\val\\")
